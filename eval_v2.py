...
LORA_PATH = "./output/Qwen2.5-VL-Video-SFT-v2/final-full"  # 或 final-answer_only
TEST_JSON = "test_v2.json"  # 使用 v2 数据
MAX_SAMPLES = None
    ...
    with open(output_file, "w") as f:
        json.dump({
            "metrics": {
                ...
                "per_category": {cat: stats["correct"]/stats["total"] if stats["total"]>0 else 0 
